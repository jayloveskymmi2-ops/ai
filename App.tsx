...
const App: React.FC = () => {
  ...
  const handleGenerateLyrics = useCallback(async () => {
    ...
    idea, isExplicit, selectedPreset, rhymeComplexity, storytellingDepth, 
    emotionalTone, vocabularyLevel, adLibIntensity, regionalFlavor, energyLevel,
    alliterationLevel, punchlineDensity, artistReference
  ]);
      ...
      <div className="w-full max-w-5xl">
        ...
        <main className="mt-8">
          <LyricsForm
            ...
            setAlliterationLevel={setAlliterationLevel}
            punchlineDensity={punchlineDensity}
            setPunchlineDensity={setPunchlineDensity}
            artistReference={artistReference}
            setArtistReference={setArtistReference}
